...
const sections = [
  ...
  { id: "why-lunchlogic", label: "Why LunchLogic" },
  ...
  return (
    <div className="min-h-screen bg-[var(--background)]">
      ...
      <main className="pt-16">
            ...
            <div className="space-y-7">
              ...
              <div className="space-y-5">
                <h1 className="font-headline max-w-4xl text-5xl font-extrabold tracking-[-0.06em] text-[var(--ink)] sm:text-6xl lg:text-7xl">
                  One child profile. Smarter lunchbox decisions every school day.
                </h1>
                <p className="max-w-2xl text-lg leading-8 text-[var(--muted-ink)]">
                  LunchLogic helps parents set up one child profile on this device, analyze today&apos;s tiffin in seconds,
                  and get practical suggestions shaped by nutrition goals, sensory comfort, allergies, and school rules.
                </p>
              </div>
              <div className="flex flex-wrap gap-4">
                <button type="button" onClick={handleStart} className="app-button-primary min-w-[15rem] text-lg">
                  {isChecking ? "Opening LunchLogic..." : "Set up your child"}
                </button>
              ...
              <div className="grid gap-4 sm:grid-cols-3">
                ...
                <div className="soft-card p-5">
                  ...
                  <p className="mt-3 text-sm leading-6 text-[var(--muted-ink)]">
                    Child setup and analysis history stay in localStorage for this prototype.
                  </p>
                </div>
                <div className="soft-card p-5">
                  <p className="text-xs font-bold uppercase tracking-[0.18em] text-[color:rgba(56,56,51,0.48)]">
                  ...
                  <p className="mt-3 text-sm leading-6 text-[var(--muted-ink)]">
                    Dashboard, analysis, tips, history, and setup all work from one profile.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-[2.5rem] bg-white p-6 shadow-[0_18px_48px_rgba(56,56,51,0.05)]">
              <div className="rounded-[2rem] bg-[var(--surface-low)] p-6">
                ...
                <div className="mt-5 space-y-4">
                  {[
                    "Set up your child once with allergies, school rules, sensory notes, and lunch habits.",
          ...
          <div className="mx-auto max-w-7xl">
            <div className="max-w-3xl">
              ...
              <h2 className="font-headline mt-3 text-4xl font-extrabold tracking-[-0.05em] text-[var(--ink)]">
                Built around the real tiffin decisions parents make before school
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  body: "LunchLogic adjusts results based on allergies, school rules, appetite, eating pace, and sensory preferences.",
                },
                {
        ...
        <section id="why-lunchlogic" className="px-4 py-8 sm:px-8 sm:py-14">
          <div className="mx-auto grid max-w-7xl gap-5 lg:grid-cols-[0.95fr_1.05fr]">
            <div className="rounded-[2rem] bg-[rgba(249,229,52,0.2)] p-6">
              ...
              <p className="mt-3 text-sm leading-7 text-[var(--muted-ink)]">
                LunchLogic is meant to become the daily place parents return to before school, after lunch, and during weekly planning.
              </p>
            </div>
            <div className="grid gap-5 sm:grid-cols-2">
              {[
                ...
                "Smart tips tailored to your child profile",
              ].map((item) => (
        ...
        <section id="use-cases" className="px-4 py-8 sm:px-8 sm:py-14">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
              {[
                { title: "Child setup", href: "/onboarding", body: "A guided profile page that saves locally and doubles as edit mode." },
                ...
                { title: "Profile + history", href: "/profiles", body: "Review the current child setup and see saved lunch analyses." },
              ].map((item) => (
        ...
        <section id="privacy" className="px-4 py-8 sm:px-8 sm:py-14">
          <div className="mx-auto max-w-7xl rounded-[2rem] bg-white p-8 shadow-[0_18px_48px_rgba(56,56,51,0.05)]">
            ...
            <p className="mt-4 max-w-3xl text-sm leading-7 text-[var(--muted-ink)]">
              This prototype keeps child setup and analysis history in localStorage only. That makes it fast to demo,
