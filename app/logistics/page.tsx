    ...
    <>
      ...
      <main className="pt-24 pb-12 px-4 md:px-6 max-w-7xl mx-auto">
        ...
        <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="bg-primary-container text-on-primary-container px-6 py-4 rounded-xl flex items-center gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          {/* Compatibility Meter */}
          <section className="md:col-span-4 bg-surface-container-low rounded-xl p-8 flex flex-col justify-between overflow-hidden relative">
          ...
          <section className="md:col-span-8 bg-tertiary-container/20 rounded-xl p-8 flex flex-col md:flex-row items-center gap-8 border-2 border-tertiary-container/30">
            ...
            <div className="w-full md:w-64 aspect-square bg-surface-container-lowest rounded-xl overflow-hidden shadow-inner flex items-center justify-center p-4">
              <img
          ...
          <section className="md:col-span-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {containers.map((container, i) => (
                <div key={i} className={`bg-surface-container-lowest p-6 rounded-xl shadow-sm border-b-4 ${container.warning ? "border-error/20 hover:border-error" : container.name.includes("Latch") ? "border-secondary/20 hover:border-secondary" : "border-primary/20 hover:border-primary"} transition-all`}>
          ...
          <section className="md:col-span-7 bg-surface-container-high rounded-xl p-8 relative overflow-hidden">
            <div className="relative z-10">
          ...
          {/* AI Tips Sidebar */}
          <section className="md:col-span-5 bg-on-background text-white rounded-xl p-8 flex flex-col gap-6">
            <div className="flex items-center gap-2">
            ...
            <button className="mt-auto bg-primary py-4 rounded-xl font-bold hover:bg-primary-dim transition-colors flex items-center justify-center gap-2">
