export default function WeeklyTrendsSection() {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-5 bg-secondary-container/10 rounded-lg p-8">
          ...
          <div className="space-y-6">
            {[
              { icon: "water_drop", pct: "80%", bg: "bg-blue-500", lightBg: "bg-blue-100", iconColor: "text-blue-600" },
              { icon: "local_fire_department", pct: "3/5 days", bg: "bg-orange-500", lightBg: "bg-orange-100", iconColor: "text-orange-600", subtitle: "60%" },
              { icon: "auto_awesome", pct: "Locked", bg: "bg-purple-200", lightBg: "bg-purple-100", iconColor: "text-purple-600", locked: true, subtitle: "30%" },
            ].map((milestone, i) => (
              <div key={i} className="flex gap-4">
                ...
                <div className="flex-1">
                  <div className="flex justify-between mb-1">
                    <span className="font-headline font-bold text-sm">{["Hydration Hero", "Lunch Streak", "Protein Prodigy"][i]}</span>
                  ...
                  <div className="h-2 w-full bg-surface-container-high rounded-full">
                    <div className={`h-full ${milestone.bg} rounded-full`} style={{ width: milestone.locked ? "30%" : i === 0 ? "80%" : "60%" }}></div>
                  </div>
                </div>
              </div>
            ))}
